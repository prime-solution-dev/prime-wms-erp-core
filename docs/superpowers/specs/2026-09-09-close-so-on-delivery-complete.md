...
4. ปิดเมื่อ `issued >= target * (1 - TOLERANCE_SO/100)` — **ไม่มีเพดานบน** (ส่งเกินถือว่าครบ)
   ยืนยันแล้ว 2026-09-09: เจ้าของไปคุยกับทีมมาแล้วและเคาะว่า **ไม่เอาเพดานบน**
   (เคยลองใส่กลับใน commit 5cfeca9 แล้ว revert ออก) ห้ามใส่เพดานบนกลับเข้ามาอีกโดยไม่ถามเจ้าของ
