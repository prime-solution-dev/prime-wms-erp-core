...
4. ~~tolerance เป็นกรอบ `>= min && <= max` → ส่งเกินเพดานแล้วใบไม่ปิด~~ — เจ้าของเคาะ 2026-09-09 ว่าให้คงกรอบสองด้านไว้ ไม่ถือเป็นข้อบกพร่องอีก
...
4. ปิดเมื่อยอดอยู่ในกรอบ `target * (1 - TOLERANCE_SO/100) <= issued <= target * (1 + TOLERANCE_SO/100)`
   — **มีเพดานบน** (เจ้าของสั่งคงไว้ 2026-09-09 เหมือนโค้ดเดิมฝั่ง wms-outbound)
   ผลที่ต้องรู้: บรรทัดที่ส่งเกินเพดาน (เป้า 10 ส่ง 11 ที่ 3%) จะไม่ปิดอัตโนมัติ ต้องปิดด้วยมือที่หน้าจอ
   ถือเป็นเรื่องที่คนต้องมาดู ไม่ให้ระบบปิดเงียบๆ
