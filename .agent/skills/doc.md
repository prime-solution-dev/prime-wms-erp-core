...
├── scripts/      # (Optional) python3 or Bash scripts
...
**Prompt**: `Create a new python3 script named data_processor.py that prints 'Hello World'.`

The Agent will read the template, convert the comments to python3 style, and automatically add it to the top of the file.
