...
func GetPOBigLot(ctx *gin.Context, jsonPayload string) (interface{}, error) {
	...
	prePurchaseList, total, page, pageSize, totalPage, err := prePurchaseRepository.GetPOBigLotList(req.PrePurchaseCodes, req.CompanyCode, req.SiteCode, req.Page, req.PageSize)
	if err != nil {
